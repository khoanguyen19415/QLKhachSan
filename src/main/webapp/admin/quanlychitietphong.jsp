                ...
                <div class="title-row mb-3">
                    ...
                    <div class="title-actions">
                        ...
                        <button id="btnShowEdit" class="btn btn-sm btn-primary">
                            <i class="bi bi-pencil-square"></i> Sửa chi tiết phòng
                        </button>
                    </div>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (json && json.status === "success") {
                            ...
                            alert("Cập nhật/Thêm thất bại. Vui lòng thử lại.");
                        }
                    },
                    error: function() {
                        alert("Có lỗi xảy ra khi gửi yêu cầu. Kiểm tra Console/Network.");
                    }
                });
            });
        });
