                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center mb-0">
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/QL-Khachhang?action=list&page=${currentPage-1}&size=${pageSize}" aria-label="Previous">
                                        &laquo;
                                    </a>
                                </li>
                                ...
                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                                        <a class="page-link" href="${pageContext.request.contextPath}/QL-Khachhang?action=list&page=${i}&size=${pageSize}">${i}</a>
                                    </li>
                                </c:forEach>

                                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/QL-Khachhang?action=list&page=${currentPage+1}&size=${pageSize}" aria-label="Next">
                                        &raquo;
                                    </a>
                                </li>
                            </ul>
