                ...
                <div class="col-md-10 mt-4">
                    ...
                    <div class="mt-4 d-flex flex-column align-items-center">
                        <div class="text-muted mb-2">
                            Trang ${currentPage} / ${totalPages} — Tổng <strong>${totalItems}</strong> khách hàng
                        </div>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center mb-0">
                                ...
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="<%=ctx%>/QL-Khachhang?action=list&page=${currentPage-1}&size=${pageSize}" aria-label="Previous">&laquo;</a>
                                </li>

                                <% if (start > 1) {%>
                                <li class="page-item"><a class="page-link" href="<%=ctx%>/QL-Khachhang?action=list&page=1&size=${pageSize}">1</a></li>
                                    <% if (start > 2) { %>
                                ...
                                <li class="page-item <%= (i == (Integer) request.getAttribute("currentPage") ? "active" : "")%>">
                                    <a class="page-link" href="<%=ctx%>/QL-Khachhang?action=list&page=<%=i%>&size=${pageSize}"><%=i%></a>
                                </li>
                                <% } %>
                                ...
                                <li class="page-item disabled"><span class="page-link">...</span></li>
                                    <% }%>
                                <li class="page-item"><a class="page-link" href="<%=ctx%>/QL-Khachhang?action=list&page=${totalPages}&size=${pageSize}">${totalPages}</a></li>
                                    <% }%>

                                <!-- Nút Sau -->
                                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                    <a class="page-link" href="<%=ctx%>/QL-Khachhang?action=list&page=${currentPage+1}&size=${pageSize}" aria-label="Next">&raquo;</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
